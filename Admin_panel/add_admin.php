...
<div id="main_container">
	...
	<h1>Register new Admin</h1> 
     ...
     <h2>Insert new username/password</h2>
...
function validate()
{
   ...
   if( document.myForm.password.value == "" )
   {
     ...
     return false;
         ...
         <form action="add_admin_project.php" method="post" class="niceform" name="myForm" onsubmit="return(validate())">
         
                <fieldset>
                	<!-- <dl>
                        <dt><label for="">admin id: </label></dt>
					...
					<font color="red">*REQUIRED FIELD</font>
                        ...
                        <dt><label for=""><font color="red">*</font>UserName:</label></dt>
                        <dd><input type="text" name="username" id="" size="54" /></dd>
                    </dl>
                    <dl>
                        <dt><label for=""><font color="red">*</font>Password:</label></dt>
