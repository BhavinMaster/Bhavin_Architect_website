...
?>        
	<h1>Fill the Project Type details</h1> 
  ...
  if( document.myForm.project_type.value == "" )
   {
     ...
     <h2>Update Project type For ID::><?php echo $strid; ?></h2>
         <div class="form">
         <form action="type_updated.php" method="post" class="niceform" name="myForm" onsubmit="return(validate())">
             	...
             	<dl>
					<font color="red">*REQUIRED FIELD</font>
             		...
             		<dl>	
                        ...
                        <dd><input type="hidden" name="id" id="" size="54" value="<?php echo $strid;?>" /></dd>                 	
                 	</dl>
                    <dl>
                        <dt><label for=""><font color="red">*</font>Project Type:</label></dt>
                        <dd><input type="text" name="project_type" id="" size="54" /></dd>
                    </dl>                    
