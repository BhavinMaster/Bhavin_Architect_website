...
function validate()
{
   ...
   if( document.ser.name.value == "" )
   {
	...
	<h1>Delete Project</h1> 
	 <div class="form">
         <form action="delete_record.php" method="post" class="niceform">            
<?php
...
while($row = mysql_fetch_array($result)) {
  ...
  echo "<td>" . $row['project_review'] . "</td>";
  echo '<td> <a href="delete_record.php?imgid='.$stdid.'" class="ask"> <img src = "images/trash.png" alt="" title="" border="0" > </a></td>';	 
  echo "</tr>";
}
