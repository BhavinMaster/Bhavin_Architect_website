...
function validate()
{
   ...
   if( document.ser.name.value == "" )
   {
	...
	<h1>Delete Project Type</h1> 
	    <div class="form">
         <form action="delete_project_type_record.php" method="post" class="niceform">
...
while($row = mysql_fetch_array($result)) {
 ...
 $stdid=$row['id'];
  ...
  echo '<td> <a href="delete_project_type_record.php?imgid='.$stdid.'" class="ask"> <img src = "images/trash.png" alt="" title="" border="0" > </a></td>';	 
  echo "</tr>";
}
