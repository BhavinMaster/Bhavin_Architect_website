...
function validate()
{
   ...
   if( document.ser.name.value == "" )
   {
     ...
     return false;
            ...
            <form action = "search_about_us.php" method = "post" name="ser" onsubmit="return(validate())">
	...
	<h1>Delete About_us</h1> 
	 <div class="form">
         <form action="delete_about_us.php" method="post" class="niceform">            
<?php
...
while($row = mysql_fetch_array($result)) {
  ...
  echo '<td> <a href="delete_about_us.php?imgid='.$stdid.'" class="ask"> <img src = "images/trash.png" alt="" title="" border="0" > </a></td>';	 
  echo "</tr>";
}
