...
<div id="main_container">
    ...
    <div class="right_content" >            
     <h2>Remove Existing Admin Login</h2>
	 <div class="form">
         <form action="delete_admin.php" method="post" class="niceform">
...
while($row = mysql_fetch_array($result)) {
  ...
  echo '<td> <a href="delete_admin.php?imgid='.$stdid.'" class="ask"> <img src = "images/trash.png" alt="" title="" border="0" > </a></td>';	 	 
  echo "</tr>";
}
