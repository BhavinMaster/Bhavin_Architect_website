...
function validate()
{
   ...
   if( document.ser.name.value == "" )
   {
     ...
     return false;
            ...
            <form action = "search_project.php" method = "post" name="ser" onsubmit="return(validate())">
...
echo "<h2>Search result of " . $newname . " Keyword</h2>"; 

$result=mysql_query("select * from employee_table where emp_name = '".$newname."'");
