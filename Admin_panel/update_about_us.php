...
function validate1()
{
   ...
   if( document.ser.name.value == "" )
   {
     ...
     return false;
            ...
            <form action = "search_about_us.php" method = "post" name="ser" onsubmit="return(validate1())">
...
echo '<td> <a href="update_about_record.php?imgid='.$id.'"> <img src = "images/user_edit.png" alt="" title="" border="0" > </a></td>';
...
function validate()
	{
		...
		if (isNaN(x)) 
		{
         ...
         <form action="update_about_us_php.php" method="post" class="niceform" name="myForm" onsubmit="return(validate())">
