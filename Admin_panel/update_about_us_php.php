...
<div id="main_container">
	...
	<h1>Fill the About_us details</h1> 
	
	
          

     <h2>Update About_us For ID :::> <?php $ID = mysql_real_escape_string($_POST['id']);
echo $ID;?></h2>
...
function validate()
{
   ...
   if( document.myForm.description.value == "" )
   {
	 ...
	 <div class="form">
				...
				<form action="Update_about_fully.php" method="post" enctype="multipart/form-data" class="niceform" name="myForm" onsubmit="return(validate())">
                <fieldset>
