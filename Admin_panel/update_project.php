...
function validate1()
{
   ...
   if( document.ser.name.value == "" )
   {
     ...
     return false;
            ...
            <form action = "search_project.php" method = "post" name="ser" onsubmit="return(validate1())">
...
echo '<td width="100px">'.$rows['project_name'].'</td>';
echo '<td width="100px">'.$rows['description'].'</td>';
echo '<td width="100px">'.$rows['project_review'].'</td>';
echo '<td> <a href="update_record.php?imgid='.$id.'"> <img src = "images/user_edit.png" alt="" title="" border="0" > </a></td>';
...
?>	 	 
	  ...
	  <div class="form">
         ...
         <form action="update_add_detail.php" method="post" class="niceform" name="myForm" onsubmit="return(validate())">
				...
				<dl>
                    ...
                    <dl>
                        <dt><label for=""><font color="red">*</font>Enter Project id to Update:</label></dt>
