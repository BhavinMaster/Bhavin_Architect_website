...
function validate1()
{
   ...
   if( document.ser.name.value == "" )
   {
     ...
     return false;
            ...
            <form action = "search_team.php" method = "post" name="ser" onsubmit="return(validate1())">
...
echo '<td>'.$rows['id'].'</td>';
echo '<td width="100px">'.$rows['emp_name'].'</td>';
echo '<td width="100px">'.$rows['designation'].'</td>';
echo '<td width="100px">'.$rows['joining_date'].'</td>';
echo '<td width="100px">'.$rows['contact_no'].'</td>';
echo '<td> <a href="update_team_record.php?imgid='.$stdid.'"> <img src = "images/user_edit.png" alt="" title="" border="0" > </a></td>';
...
?>
	  ...
	  <div class="form">
         ...
         <form action="update_team_project.php" method="post" class="niceform" name="myForm" onsubmit="return(validate())">
                ...
                <dl>
                    ...
                    <dl>
                        <dt><label for=""><font color="red">*</font>Enter Employee id to Update:</label></dt>
 	 ...
 	 <!--<a href="Add_new_Project.html" class="bt_green"><span class="bt_green_lft"></span><strong>Add new item</strong><span class="bt_green_r"></span></a>
