...
function validate1()
{
   ...
   if( document.ser.name.value == "" )
   {
     ...
     return false;
            ...
            <form action = "search_type.php" method = "post" name="ser" onsubmit="return(validate1())">
...
while($row = mysql_fetch_array($result)) {
  ...
  echo "<td>" . $row['id'] . "</td>";
  echo "<td>" . $row['type'] . "</td>";
  echo '<td> <a href="update_type_record.php?imgid='.$stdid.'"> <img src = "images/user_edit.png" alt="" title="" border="0" > </a></td>';
...
?>
         ...
         <form action="add_update_project_type.php" method="post" class="niceform" name="myForm" onsubmit="return(validate())">
